                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <br>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-newspaper"></i>Artical Management</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('author.articles')}}">Manage Article <span class="badge badge-secondary">Manage Article</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('author.create.article')}}">Add New Article <span class="badge badge-secondary">Add New Article</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
...
@yield('content')
    ...
    <script src="{{asset('admin/assets/libs/js/summernote.min.js') }}"></script>

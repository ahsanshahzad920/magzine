...
<html lang="en">
   ...
   <body>
      ...
      <!-- signup form  -->
      <!-- ============================================================== -->
      <form class="splash-container" method="POST" action="{{ route('create.user') }}">
         @csrf
         <div class="card">
            ...
            <div class="card-body">
               <div class="form-group">
                  <input class="form-control form-control-lg" type="text" id="name" name="name" required="" placeholder="Enter Name" autocomplete="off">
               </div>
               <div class="form-group">
